...
class Cart extends Model
{
	...
	public function removeProductCart(Product $product, $all = false)
	{
		$sql = new Sql();
	...
	public function getProducts()
	{
		...
		return Product::checkList($sql->select("SELECT b.idproduct, b.desproduct, b.vlprice, b.vlwidth, b.vlheight, b.vllength, b.vlweight, b.desurl, COUNT(*) AS nrqtd, SUM(b.vlprice) AS vltotal FROM tb_cartsproducts a 
	...
	public function setFreight($nrzipcode)
	{
		...
		*/
		if ($totals['nrqtd'] > 0) {
			...
			$xml = simplexml_load_file("http://ws.correios.com.br/calculador/CalcPrecoPrazo.asmx/CalcPrecoPrazo?".$dates);
	...
	{
		$this->getCaculateTotal();

		return parent::getValues();
	}

	public function getCaculateTotal()
	{
		$this->updateFreight();
