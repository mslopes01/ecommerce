...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li><a href="/arbeitfirma/users">Usuários</a></li>
    <li class="active"><a href="/arbeitfirma/users/create">Cadastrar</a></li>
  </ol>
</section>
...
<section class="content">
  ...
  <div class="row">
  	<div class="col-md-12">
        ...
        <!-- /.box-header -->
        <!-- form start -->
        <form role="form" action="/arbeitfirma/users/create" method="post">
          <div class="box-body">
